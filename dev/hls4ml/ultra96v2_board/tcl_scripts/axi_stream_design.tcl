...
create_project project_1 ${project_name}_vivado_accelerator -part xczu3eg-sbva484-1-i -force
...
# Ultra96-v2 has no official Vivado board preset — skip apply_board_preset and configure manually.
# PSU__USE__S_AXI_GP0 enables S_AXI_HPC0_FPD (HPC0 on xczu3eg supports snooping; GP0 is the config key).
